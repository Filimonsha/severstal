...
//           "transform",
//           "translate(0," +
//             (-currentPosition % (maxDistance * unitConversionRate)) +
//             ")"
//         );
//       } else {
//         g.setAttribute(
...
//             Math.round(
//               (startTextPos +
//                 (j - additionalDivisionsAmount * amountPerMaxDistance) *
//                   textConfig.pixelGap) *
//                 scale *
//                 100
//             ) / 100;
...
//       var svg = new Blob([svgClone.outerHTML], {
...
//       }
//       endPosition =
//         size - (size % maxDistance) + maxDistance * additionalDivisionsAmount;
...
//       var globalClassName = isVerticalRuler
//         ? "rulez-guide-vert-global"
//         : "rulez-guide-horiz-global";
...
//       return _createLineGeneral(
//         pos,
//         elementConfig.className,
//         elementConfig.lineLength,
//         elementConfig.strokeWidth
//       );
//     }

//     function _createRect(pos, elementConfig) {
//       return _createRectGeneral(
//         pos,
//         elementConfig.className,
//         elementConfig.lineLength,
//         elementConfig.strokeWidth
...
//       line.setAttribute(
//         y1,
//         addUnits(defaultAlignment ? "0" : getAlignmentOffset() - lineLength)
//       );
//       line.setAttribute(
//         y2,
//         addUnits(defaultAlignment ? lineLength : getAlignmentOffset())
//       );
//       line.setAttribute("stroke-width", addUnits(strokeWidth));
//       return line;
//     }

//     function _createRectGeneral(
//       pos,
//       className,
//       lineLength,
//       strokeWidth,
...
//           if (!entry.className) {
//             entry.className =
//               entry.type === "line" ? "rulez-line" : "rulez-rect";
//           }
//         });
//       }
//       if (def.texts) {
...
//           " " +
//           yPos * unitConversionRate +
//           " " +
//           pos * unitConversionRate +
//           ")";
//       } else {
//         rotate =
//           "rotate(" +
...
//         ? elementConfig.offset
//         : getAlignmentOffset() - elementConfig.offset;
//     }
//   }
// }
